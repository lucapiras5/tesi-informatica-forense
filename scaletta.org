...
Distribuzioni specificamente progettate per sistemi integrati, come OpenWRT,[fn:16] o comunque genericamente progettate per utilizzare la minore quantità di risorse possibili, come Alpine Linux,[fn:17] che sostituiscono tutti gli applicativi del sistema operativo GNU con un singolo applicativo, chiamato BusyBox.[fn:18]
...
Così come non esiste "un" Unix, ma esistono più sistemi operativi derivati da Unix, non esiste "un" Linux, ma piuttosto, un numero di /distribuzioni Linux/.[fn:19]

Linux in sé non è nemmeno un sistema operativo, ma soltanto un suo componente fondamentale.[fn:20]

Ogni distro[fn:21] usa il /kernel Linux/, e la stragrande maggioranza usa il /sistema operativo GNU/.
...
[fn:3] Stallman, /Initial Announcement/.

[fn:4] Torvalds, /Notes for linux/.

[fn:5] Tanenbaum, /Unix clone/, p. 21.
...
[fn:15] Hans Lub, /rlwrap/.

[fn:16] OpenWRT, /OpenWRT Project/.

[fn:17] Alpine Linux, /About/.

[fn:18] BusyBox, /BusyBox/.

[fn:19] DistroWatch, /Major Distributions/.

[fn:20] Stallman, /Linux/.

[fn:21] /Distro/, pl. /distros/ è l'abbreviazione colloquiale di /distribution/.

[fn:22] Cf. https://wiki.debian.org/it/DebianReleases
