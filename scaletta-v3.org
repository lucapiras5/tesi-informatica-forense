...
Per quanto riguarda l'informatica forense:
...
*Limiti legali alla RE.*  Anche quando si agisce per fini pubblici (ad es., al servizio di un procedimento o processo penale), la RE entra in tensione con il diritto d'autore.
...
Art. 6 della European Software Directive: la RE è amessa solo per fini di interoperabilità, non per creare programmi che hanno sostanzialmente la stessa funzione.
